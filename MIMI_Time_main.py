...
<details class="license-section">
  ...
  <div class="license-text">
    © 2026 yu-sabu<br>
    ※本文は簡易版のライセンス表記です。詳しくは「ご利用について」をご覧ください。<br>
...
あわせて設定内の「ご利用について」をご覧いただきますようお願い申し上げます。
</p>
...
<p>
MIMI Timeをご利用いただくにあたっての内容をまとめています。<br>
このサイトを安心して楽しんでいただくために、著作権や禁止事項、外部サービスの利用などについてご案内しています。
</p>
...
<p>
本ページは、MIMI Time（以下「本サイト」）の利用条件について定めるものです。<br>
...
楽曲、映像、ジャケット画像等の著作権は各権利者様に帰属します。
</p>

<p>
本サイトに掲載している文章、デザイン、プログラム等
（権利者に帰属するコンテンツを除く）の著作権は、MIMI Time運営者に帰属します。
</p>

<p>
GitHub上で公開しているソースコードについては、
各リポジトリに記載されたライセンスに従ってご利用ください。
</p>
...
<li>AI学習を目的として本サイトの内容を利用する行為</li>
<li>その他、運営者が不適切と判断する行為</li>
<li>本サイトに対する過度なアクセスや、不正なプログラム等によってサーバーへ過度な負荷を与える行為</li>
</ul>
...
ただし、そのままの複製や、MIMI Timeと誤認を招くような構成はお控えください。<br>
...
<p>
本サイトは正確な情報の提供に努めていますが、
その正確性・完全性・最新性を保証するものではありません。<br>
本サイトの利用によって生じたいかなる損害についても、運営者は責任を負いかねます。
</p>
...
<p>
本ページの内容は、必要に応じて変更される場合があります。<br>
変更後の内容は、本ページへ掲載した時点で反映されるものとします。
</p>
...
<p>
本サイトに関するお問い合わせは、以下よりお願いいたします。
</p>

<p>
X（旧Twitter）でのお問い合わせ<br>
<a href="https://x.com/yu_sabu_P" target="_blank" rel="noopener noreferrer">
...
<h2>ご利用について</h2>
<p>
本サイトの利用条件やガイドラインについては下記の「ご利用についてを見る」からご覧いただけます。<br>
